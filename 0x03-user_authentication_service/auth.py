#!/usr/bin/env python3
"""
A module that implements authentication relate routines
"""
import bcrypt
...
class Auth:
    """
    A class that interacts with the authentication database
    """
    ...
    def destroy_session(self, user_id: int) -> None:
        """
        Destroy a session associatef with a given user
        """
        if user_id is None:
            return None
